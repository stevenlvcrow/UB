    ...
    <section>
        <div class="desktop">
            <div id="win10-shortcuts" class="shortcuts-hidden">
                ...
                <div class="shortcut" onclick="Win10.openUrl('https://yuri2.cn','<img class=\'icon\' src=\'static/icon/blogger.png\'/>尤里2号的博客')">
                    <img class="icon" src="static/icon/blogger.png"/>
                    <div class="title">Yuri2's Blog</div>
                </div>
                <div class="shortcut" onclick="Win10.openUrl('win10ui.yuri2.cn/src/doc.php','<img class=\'icon\' src=\'static/icon/doc.png\'/>在线文档')">
                    <img class="icon" src="static/icon/doc.png"/>
                ...
                <div class="shortcut" onclick="Win10.openUrl('https://www.oschina.net/p/win10-ui','<img class=\'icon\' src=\'static/icon/kyzg.png\'/>开源中国（求支持~）')">
                    <img class="icon" src="static/icon/kyzg.png"/>
                    <div class="title">开源中国</div>
                </div>
                <div class="shortcut" onclick="window.open('https://github.com/yuri2peter/win10-ui/archive/master.zip')">
                    <img class="icon" src="static/icon/download.png"/>
                    <div class="title">快速获取</div>
                </div>
                <div class="shortcut" onclick='Win10.openDiv("win10-login","<i class=\"fa fa-user icon black-green\"></i>示例登录页")'>
        ...
        <div id="win10-menu" class="hidden">
            <div class="list win10-menu-hidden animated animated-slideOutLeft">
                ...
                offset:'50px',
                shadeClose:true,
                content: '<img width=\'300\' src=\'static/presentation/donation.jpg\' />'
                ...
                <div class="sub-item">
                    <img class="icon" src="http://win10ui.yuri2.cn/src/img/icon/win10.png" />
            ...
            <div class="blocks">
                <div class="menu_group">
                    ...
                    <div loc="1,1" size="6,3" class="block">
                        ...
                        <div class="content red cover">
                            <img width="264" style="position: relative;top: -50px;" src="static/presentation/wangyiyun.gif" />
                        </div>
                    </div>
                ...
                <div class="menu_group">
                    ...
                    <div loc="5,2" size="2,2" class="block">
                        <div class="content">
                            <img style="width: 40px;height: 40px;margin: 5px auto;display: block" src="static/icon/baidu.png">
                            <div class="win10-block-content-text">图标按钮</div>
                        </div>
                    </div>
                    <div loc="1,4" size="6,3" class="block">
                        <!--<div class="content" style="background: url('static/presentation/1.png');background-size: auto">-->
...
<script>
    ...
    export default {
        ...
        mounted:function () {
            ...
            //设置壁纸
            Win10.setBgUrl({
                main:'static/wallpapers/main.jpg',
